                ...
                <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
                    <thead>
                        <tr className='border-b'>
                            ...
                            <th className='py-2 px-4 text-left max-sm:hidden' >Jon Title</th>
                    ...
                    <tbody>
                        {
                            applicants.filter(item => item.jobId && item.userId).map((applicant, index) => (
                                <tr key={index} className='text-gray-700'>
                                    ...
                                    <td className='py-2 px-4 border-b max-sm:hiiden'>{applicant.jobId.location}</td>
                                    ...
                                    <td className='py-2 px-4 border-b relative'>
                                        {applicant.status === 'Pending' ? (
                                            <div className='relative inline-block tetx-left group '>
                                                <button className='text-gray-500 action-button'>...</button>
                                                <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded group-hover:block'>
